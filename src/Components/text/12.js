...
export const v12 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/12/12.jpg" id="chapImage" />
        </div>

        <div className="title2"> XII. COMERCIO INTERNACIONAL </div>
        ...
        <div className="subtitle"> RICARDO CONTRA SMITH </div>
        ...
        <div className="subtitle"> DIVISIÓN DEL TRABAJO </div>
        ...
        <div className="subtitle"> COMERCIO EXTERIOR SOCIALISTA </div>
        ...
        <div className="subtitle"> PRIVILEGIOS E INTERESES </div>
        ...
        <div className="subtitle"> COMERCIO EXTERIOR Y DESARROLLO </div>
