...
export const v11 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/11/11.jpg" id="chapImage" />
        </div>

        <div className="title2"> XI. MALTHUSIANISMO </div>
        ...
        <div className="subtitle"> HEBREOS EN EGIPTO </div>
        ...
        <div className="subtitle"> OPORTUNIDADES DE PROGRESO </div>
        ...
        <div className="subtitle"> DERECHO Y PRIVILEGIO </div>
        ...
        <div className="subtitle"> MALTHUS MAYOR </div>
