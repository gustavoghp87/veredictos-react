...
export const v15 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/15/15.jpg" id="chapImage" />
        </div>

        <div className="title2"> XV. INFLACIÓN </div>

        <ul> 1. La inflación es el fenómeno más consultado de toda la economía. Es el origen de debates, controversias, posiciones ideológicas y experimentos gubernamentales de todo tipo. Y no porque sí esta será la sección más larga del sitio. Pero la realidad científica es una sola. </ul>


        <div className="subtitle"> CONTEXTO </div>
        ...
        <div className="subtitle"> MERCADO DE DINERO </div>
        ...
        <img src="/frontend-src/15/money.jpg" className="image-center" />
        ...
        <div className="subtitle"> VELOCIDAD DE CIRCULACIÓN DEL DINERO </div>
        ...
        <div className="subtitle"> OFERTA DE DINERO </div>
        ...
        <div className="subtitle"> CASOS DE INFLACIÓN </div>
        ...
        <div className="subtitle"> EMISIÓN Y REDISTRIBUCIÓN DE VALOR </div>
        ...
        <div className="subtitle"> INFLACIÓN Y CRÉDITO </div>
        ...
        <div className="subtitle"> CRISIS Y EMISIÓN </div>
        ...
        <img src="/15/15b.jpg" className="image-center" />
        ...
        <div className="subtitle"> HIPERINFLACIÓN </div>
        ...
        <div className="subtitle"> EL ROL DE LA DEMANDA DE DINERO </div>
        ...
        <div className="subtitle"> EFECTOS EXPANSIVOS </div> 
        ...
        <div className="subtitle"> CONCLUSIÓN </div>
        ...
        <div className="subtitle"> LA INFLACIÓN Y EL SOCIALISTA </div>
