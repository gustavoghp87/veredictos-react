...
export const v21 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/21/21.jpg" id="chapImage" />
        </div>

        <div className="title2"> XXI. NEOLIBERALISMO </div>
        ...
        <div className="subtitle"> NEOLIBERALISMO Y EL ESTADO EN<br />EL MERCADO DE DINERO </div>
