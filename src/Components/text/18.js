...
export const v18 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/18/18.jpg" id="chapImage" />
        </div>

        <div className="title2"> XVIII. ¿QUÉ HAY PODRIDO EN EL FMI? </div>
        ...
        <div className="subtitle"> ORIGEN: 1944 </div>
        ...
        <div className="subtitle"> INTERPRETACIÓN SOCIALISTA DE<br />LA CRISIS DEL PATRÓN ORO </div>
        ...
        <div className="subtitle"> BORRADOR DE FMI Y NACIMIENTO (1944) </div>
        ...
        <div className="subtitle"> AJUSTE Y PREGUNTA </div>
        ...
        <div className="subtitle"> RESISTENCIA DE LOS PRECIOS A<br />LA BAJA Y DEVALUACIONES </div>
        ...
        <div className="subtitle"> NATURALEZA SOCIALISTA DEL FMI </div>
        ...
        <div className="subtitle"> DESAJUSTE DE BALANZA DE PAGOS </div>
        ...
        <div className="subtitle"> RESERVAS </div>
        ...
        <div className="subtitle"> NÉMESIS DEL FMI </div>
        ...
        <div className="subtitle"> FIN DEL PATRÓN ORO </div>
