...
export const v23 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/23/23.jpg" id="chapImage" />
        </div>

        <div className="title2"> XXIII. LA INTERPRETACIÓN<br />MATERIALISTA DE LA HISTORIA </div>
        ...
        <div className="subtitle"> DETERMINISMO ECONÓMICO </div>
        ...
        <div className="subtitle"> LAS FASES DE LA HISTORIA HUMANA </div>
        ...
        <div className="subtitle"> EL FIN DE LA HISTORIA </div>
