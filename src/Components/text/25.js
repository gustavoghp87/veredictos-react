...
export const v25 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/25/25.jpg" id="chapImage" />
        </div>

        <div className="title2"> XXV. EL GENOMA SOCIALISTA </div>
        ...
        <div className="subtitle"> CIENCIA ECONÓMICA </div>
        ...
        <div className="subtitle"> PROGRESO </div>
        ...
        <div className="subtitle"> CONCENTRACIÓN DE LA RIQUEZA </div>
        ...
        <div className="subtitle"> LOS DERECHOS NATURALES </div>
        ...
        <div className="subtitle"> SOCIALISMO Y CIENCIAS POLÍTICAS </div>
        ...
        <div className="subtitle"> LUCHA DE CLASES </div>
