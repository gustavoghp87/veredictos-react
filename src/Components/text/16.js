...
export const v16 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/16/16.jpg" id="chapImage" />
        </div>

        <div className="title2"> XVI. ¿QUÉ PASA CON LOS BANCOS CENTRALES? </div>
        ...
        <div className="subtitle"> DINERO, CRÉDITO Y BANCOS </div>
        ...
        <div className="subtitle"> LA RESERVA FRACCIONARIA </div>
        ...
        <div className="subtitle"> PÁNICO BANCARIO </div>
        ...
        <div className="subtitle"> CANTIDAD DE CIRCULANTE </div>
        ...
        <div className="subtitle"> CÁRTELES DE LA BANCA </div>
        ...
        <div className="subtitle"> RECAPITULACIÓN SOBRE RESERVA<br/>FRACCIONARIA </div>
        ...
        <div className="subtitle"> EL BANCO CENTRAL DE<br />PRIMERA GENERACIÓN</div>
        ...
        <div className="subtitle"> PATRÓN ORO | STANDARD GOLD </div>
        ...
        <div className="subtitle"> DOBLE META IMPOSIBLE </div>
        ...
        <div className="subtitle"> IMPORTANCIA DEL PATRÓN ORO </div>
        ...
        <div className="subtitle"> EL BANCO CENTRAL MODERNO </div>
        ...
        <div className="subtitle"> RESPUESTAS </div>
        ...
        <div className="subtitle"> COINCIDENCIA DE INTERESES </div>
