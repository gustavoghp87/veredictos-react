...
export const v17 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/17/17.jpg" id="chapImage" />
        </div>

        <div className="title2"> XVII. ¿QUÉ PASÓ EN 1929? </div>
        ...
        <div className="subtitle"> PRIVADO O PÚBLICO </div>
        ...
        <img src="/frontend-src/17/jackson4.jpg" className="image-center" />
        ...
        <div className="subtitle"> INCUBACIÓN DEL CRASH </div>
        ...
        <div className="subtitle"> DINERO Y PATRÓN ORO </div>
        ...
        <div className="subtitle"> CONFISCACIÓN DE TODO EL ORO </div>
        ...
        <div className="subtitle"> NEW DEAL </div>
        ...
        <div className="subtitle"> SOCIALISMO BELICISTA </div>
