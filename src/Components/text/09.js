...
export const v09 = () => {
    ...
    <div>
        <div>
            <img src="/frontend-src/09/09.jpg" id="chapImage" />
        </div>

        <div className="title2"> IX. CONCENTRACIÓN Y CÁRTELES </div>
        ...
        <div className="subtitle"> ORIGEN DE LA CONCENTRACIÓN </div>
        ...
        <div className="subtitle"> LOS PELIGROS DE LA CONCENTRACIÓN </div>
        ...
        <div className="subtitle"> CÁRTELES </div>
        ...
        <div className="subtitle"> MONOPOLIOS Y SOCIALISMO </div>
        ...
        <div className="subtitle"> COTIZACIÓN Y REDISTRIBUCIÓN </div>
